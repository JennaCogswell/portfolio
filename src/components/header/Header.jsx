    ...
    <div className='z-16'>
      <header className='fixed w-full h-fit'>
        <nav className='p-2 w-full'>
          <a href='index.html' className='absolute left-3 font-parisienne text-secondary text-3xl'>JC</a>
          ...
          <div className='hidden lg:flex justify-center items-center'>
            <ul className='flex font-code text-primary'>
              ...
              <li className='ml-4 mr-4'>
                <a href='#tools' className='flex items-center gap-1'>
                  <IoBuild/> Tools
                </a>
              </li>
        ...
        <button className='text-2xl items-center lg:hidden absolute right-3' onClick={toggleMenu}>
          <IoMenu/>
        </button>
      </header>
        ...
        <div className='mt-10 fixed w-full h-full '>
          ...
          <nav className='p-2 w-full h-full'>
            ...
            <div className=' w-full h-full'>
              <ul className='flex-col flex h-full font-code text-primary'>
                <li className='mb-8'>
